    ...
    <div className={styles.contenedorGeneral}>
      ...
      <div className={styles.imagenesParrafos}>
        <div className={styles.contenedorTres}>
          ...
          <p className={styles.logoTitulo}>La Nación</p>
        ...
        <div className={styles.contenedorTres}>
          ...
          <p className={styles.logoTitulo}>iProfesional</p>
        ...
        <div className={styles.contenedorTres}>
          ...
          <p className={styles.logoTitulo}>Info Technology</p>
        ...
        <div className={styles.contenedorTres}>
          ...
          <p className={styles.logoTitulo}>El Cronista</p>
        ...
        <div className={styles.contenedorTres}>
          ...
          <p className={styles.logoTitulo}>Trade Radio FM</p>
        ...
        <div className={styles.contenedorTres}>
          ...
          <p className={styles.logoTitulo}>Road Show</p>
        ...
        <div className={styles.contenedorTres}>
          ...
          <p className={styles.logoTitulo}>Apertura</p>
